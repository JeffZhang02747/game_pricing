...
#search url example :
#https://store.playstation.com/chihiro-api/bucket-search/US/en/999/bloodborne?size=30&geoCountry=US
...
search_url = "https://store.playstation.com/chihiro-api/search/US/en/999/%s?bucket=games&game_content_type=games&size=30&geoCountry=US"


best_api_key = "fjsr6ancrf4knq8vnxnyw82u"
best_search_endpointer = "https://api.bestbuy.com/v1/products(%s&(categoryPath.id=pcmcat295700050012))?apiKey=fjsr6ancrf4knq8vnxnyw82u&sort=regularPrice.asc&show=regularPrice,name&format=json"
